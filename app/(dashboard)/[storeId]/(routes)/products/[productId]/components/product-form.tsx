        ...
        <Form {...form}>
            ...
            <FormField
                    ...
                    render={({field})=> (
                        <FormItem>
                            ...
                            <FormControl>
                             <ImageUpload value={field.value.map((image)=>image.url)} disable={loading}
            ...
            <FormField
                ...
                <FormField
                    ...
                    name="isFeatured"
                    render={({field})=> (
                        <FormItem className="flex flex-row items-start rounded-md space-x-3 space-y-0 border p-4">
                            <FormControl>
                            ...
                            <div className="space-y-1 leading-none">
                                ...
                                <FormDescription>
                                    This product will apear in  home page.
                                </FormDescription>
                            </div>
                    ...
                    render={({field})=> (
                        <FormItem className="flex flex-row items-start rounded-md space-x-3 space-y-0 border p-4">
                            ...
                            <div className="space-y-1 leading-none">
                                ...
                                <FormDescription>
                                    This product will not apear in  store.
                                </FormDescription>
                            </div>
